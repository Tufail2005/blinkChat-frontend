...
import {
    ...
    import { ImageUploadHandler, UploadHandlerRef } from "@/components/ImageUploadHandler";
        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            ...
            <div className="flex flex-col items-center pt-6 px-6 pb-4 space-y-6">
                ...
                >
                    ...
                    <AvatarImage src={userDetails.photo} className="object-cover" />
                ...
                {isEditingName ? (
                    ...
                    <Input
                        ...
                        autoFocus
                    />
                    <Button size="sm" onClick={handleUpdateName} className="h-9 w-9 p-0 bg-green-500 hover:bg-green-600">
